...
ActiveRecord::Schema[7.0].define(version: 2024_03_26_153600) do
  ...
  create_table "poly_likes", force: :cascade do |t|
    ...
    t.index ["user_id", "likable_type", "likable_id"], name: "index_poly_likes_on_user_id_and_likable_type_and_likable_id", unique: true
